...
import type { AgentStoredMessage, AgentMessage, CodexReasoningEffort } from 'humanchrome-shared';
...
import type { OpenProjectTarget } from 'humanchrome-shared';
...
const currentManagementInfo = ref<import('humanchrome-shared').AgentManagementInfo | null>(null);
