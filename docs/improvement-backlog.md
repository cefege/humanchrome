...
- **Proposed by**: optimization-scout · 2026-05-06
- **Status**: in-progress (slices 1-6: navigate.ts, scroll.ts, wait.ts, assert.ts, click.ts, fill.ts, download-screenshot-attr-event-frame-loop.ts (6 nodes) typed; ~114 casts removed)
