...
- **Status**: in-progress (slices 1 + 2 of N landed: CDPHelper extracted to `browser/computer/cdp-helper.ts`; click handlers — left/right/double/triple/drag — extracted to `browser/computer/actions/click-actions.ts`)
