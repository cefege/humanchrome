...
- **Status**: in-progress (slices 1 + 2 + 3 of N landed: CDPHelper extracted to `browser/computer/cdp-helper.ts`; click handlers extracted to `browser/computer/actions/click-actions.ts`; scroll/scroll_to/zoom handlers extracted to `browser/computer/actions/scroll-zoom-actions.ts`)
