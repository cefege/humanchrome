...
- **Proposed by**: optimization-scout · 2026-05-06
- **Status**: in-progress (slices 1-4: navigate.ts, scroll.ts, wait.ts, assert.ts, click.ts (+ dblclick) typed; ~62 casts removed; click.ts also dedup'd via runClickStep helper)
